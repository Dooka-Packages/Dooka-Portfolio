...
```diff 
- This pack should not be replicated in any way. DONT sell this pack in any way. This personal sidebar addon can be added to your own pack. Make sure to add credit in the files or in your world! -
```
